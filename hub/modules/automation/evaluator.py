...
class EvaluatorEngine:
    ...
    def _execute_actions(self, actions: list):
        ...
        for act in actions:
            ...
            # Extraer número de nodo del dev_id (e.g. 'dev_1' -> 1)
            node_id = 0
            ...
            if atype in ["action_device", "action_light", "action_plug"]:
                ...
                cmd_byte = cmd_map.get(cmd_str.upper(), 0x01)
                
                # Comando real enviado a la cola del hardware
